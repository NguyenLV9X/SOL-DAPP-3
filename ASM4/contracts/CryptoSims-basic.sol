...
contract TheFunixCryptoSim is ERC721, Ownable  {
    ...
    function createGenesis() internal {
        ...
        SimAttributes memory thirdAtrributes = SimAttributes({
          body: 3,
          eye: 7,
          hairstyle: 127,
          outfit: 31,
        ...
        SimAttributes memory fourthAtrributes = SimAttributes({
          body: 3,
          eye: 7,
          hairstyle: 127,
          outfit: 31,
